...
import {AiFillTwitterSquare,AiFillFacebook,AiFillInstagram,AiFillMediumSquare,AiFillGithub} from 'react-icons/ai'
...
export const socialmedia = [
    ...
    { name : "medium", link :"https://medium.com/@hariprasad.sundharesan", icon : <AiFillMediumSquare/>},
...
export const ethics = [
  { id:'1', name: 'Open to discussion', desc: 'Ideas welcome—no thought too weird!', icon:<FiBookOpen className='ethics__icon'/>},
  { id:'2', name: 'Learning Mindset', desc: 'Keep learning… or risk being outsmarted by a script!', icon:<FaAward className='ethics__icon'/>},
  { id:'3', name: 'Actively Involved', desc: 'Listen, nod, and occasionally drop the genius idea', icon:<FiUsers className='ethics__icon'/>},
  { id:'4', name: 'Effective Planning', desc: 'Plan smart so weekends stay sacred', icon:<FiUmbrella className='ethics__icon'/>},
  { id:'5', name: 'Trust', desc: 'Earn it, sip coffee, repeat', icon:<FiCoffee className='ethics__icon'/>}
];
